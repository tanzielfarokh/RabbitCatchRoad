...
//@main
//struct Rabbit_Catch_RoadApp: App {
// 
//    var body: some Scene {
//        WindowGroup {
//            LoadingView()
...
struct Rabbit_Catch_RoadApp: App {
    ...
    private func handleScenePhaseChange(_ phase: ScenePhase) {
        ...
        case .inactive:
            // App became inactive - pause audio
...
class ServerResponseHandler: ObservableObject {
    ...
    private var serverURL: String {
        if let url = Bundle.main.object(forInfoDictionaryKey: "ServerBaseURL") as? String {
            return url + "/ios-rabbit-catch-road/server.php"
        }
        return "https://gtappinfo.site/ios-rabbit-catch-road/server.php"
    }
